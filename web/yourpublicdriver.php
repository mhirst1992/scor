<?php
  ...
  $sql = "SELECT name FROM core_Sponsors WHERE sponsorID = " . ($driver[7] + 1);
  $result = $link->query($sql);
  $primary = $result->fetch_array(MYSQLI_NUM);
  $sql = "SELECT name FROM core_Sponsors WHERE sponsorID = " . ($driver[8] + 1);
  $result = $link->query($sql);
    ...
    <div class="col-lg-6">
      <div class="card mb-2">
        ...
        <div id="sponsors" style="width: 120px; height: 200px; position: absolute; right: 10px; top: 10px;">
            <img id="spnsrimg1" class="card-img-top" src="../../img/sponsors/logo_sm/<?php echo $driver[7] + 1; ?>.png" alt="sponsor1" style="width: 100%; height: 50%; padding-bottom: 10px;">
            <img id="spnsrimg2" class="card-img-top" src="../../img/sponsors/logo_sm/<?php echo $driver[8] + 1; ?>.png" alt="sponsor2" style="width: 100%; height: 50%; padding-bottom: 10px;">
        </div>
